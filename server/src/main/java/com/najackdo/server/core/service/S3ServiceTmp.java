package com.najackdo.server.core.service;// package com.najackdo.server.core.service;
//
...
// 		String profileImage = event.getUser().getProfileImage();
//
...
// 		event.getUser().updateProfileImage(future.join());
...
// 		String cloudFrontUrl = s3Url.replace("https://s3.ap-northeast-2.amazonaws.com/najackdo/images",
// 			cloudFrontDomain);
//
